...
- [ ] Option 2 left on the table after this canonical-surface cleanup slice: publish real backend contracts for admin runtime settings and AI-ops telemetry before reintroducing those panels to the canonical admin nav.
