...
- [ ] Option 2 left on the table after this admin copy-hygiene slice: replace the remaining emoji-first controls in high-risk operator surfaces like `UsersSection` and `WorkspacesSection` with a consistent icon system or ASCII-safe labels.
