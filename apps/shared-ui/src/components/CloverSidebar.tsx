...
export function CloverSidebar({
    ...
    onLogout,
    currentPath,
    logoSrc = "/branding/clover-logo-dark-bg.png",
    navGroups,
}: CloverSidebarProps) {
    ...
    const defaultGroups: NavGroup[] = useMemo(
        () => [
            {
                id: "main",
                label: "MAIN",
            ...
            },
            {
                ...
                defaultOpen: true,
                items: [
                    { id: "pl_report", label: "Profit & Loss", icon: FileText, href: "/reports/pl" },
    ...
    const groups = navGroups ?? defaultGroups;
