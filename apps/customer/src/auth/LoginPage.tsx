    ...
    <div className="space-y-2">
      ...
      <div className="group relative">
        <input
          ...
          className={`w-full rounded-2xl border border-neutral-200 bg-white px-4 py-3 text-sm text-neutral-900 shadow-sm outline-none transition placeholder:text-neutral-400 focus:border-orange-300 focus:ring-4 focus:ring-orange-500/15 ${isPassword ? "pr-12" : ""}`}
        />
        {isPassword && (
          <button
            type="button"
